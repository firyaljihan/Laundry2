...
if($_POST){
    ...
    if(empty($nama)){
        ...
        if($insert){
            echo "<script>alert('Sukses menambahkan member');location.href='tampil_member_admin.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan member');location.href='tampil_member_admin.php';</script>";
        }
    }
}
?>