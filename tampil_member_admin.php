  ...
  <div class="container">
    <div class="card">
      <div class="card-header">
        <h1>DATA MEMBER</h1>
        <form method="POST" action="tampil_member_admin.php" class="d-flex">
        </form>  
      </div>
      <div class="card-body">
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
              <a href="ubah_member.php?id_member=
                <?=$data_member['id_member']?>" class="btn btn-success">Ubah</a>
                <a href="hapus_member.php?id_member=
                <?=$data_member['id_member']?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin menghapus data ini?'")>Hapus</a>
              </td>
            </tr>
            <?php 
            } 
        ...
        <a href="tambah_member_admin.php" type="button" class="btn btn-primary">Tambah
